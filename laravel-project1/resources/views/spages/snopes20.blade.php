...
<h1 class="title" style="text-align: center">
	<b>Was Parler Hacked in November 2020?</b></h1>



	<h2 class="subtitle">
		Rumors ran wild about the right-wing social media site Parler's getting hacked, but so far, these claims are unsubstantiated.	</h2>
	...
	<div class="card mb-3">
		...
		<div class="claim-text card-body">
			...
			The right-wing social media app Parler was hacked in November 2020.
		</div>
	...
	<div class="single-body card card-body rich-text">
        ...
        <p>On Nov. 24, 2020, a rumor started circulating on social media that the right-wing website Parler had been hacked. This rumor, which held that Parler users had their Social Security numbers and private messages stolen, was largely based on a single (since deleted) tweet and a months-old screenshot.</p>
        <p>Rumors about Parler’s being hacked went viral after Twitter user @Kevinabosch posted the following <a href="http://archive.is/GYWq7#selection-3053.0-3060.0" target="_blank" rel="noopener">message</a>: “I’ve seen what looks like legit proof of 5000 compromised Parler accounts including DM’s of some well-known figures. Hackers decompiled the app, zero day exploit etc.. I wish I could unsee what I’ve seen.”</p>
        <p>This claim, however, came without evidence. And as <a href="https://twitter.com/JaneLytv/status/1331382801984319488" target="_blank">Jane Lytvynenko</a>, a Buzzfeed reporter who monitors social media for viral misinformation, noted, this account has shared inaccurate claims on social media before. By the morning of Nov. 25, this tweet was deleted.&nbsp;</p>
        <p>In addition to the unfounded claim displayed above, a <a href="https://twitter.com/CopingMAGA/status/1331362619396149251" target="_blank">screenshot</a> supposedly showing proof of the hack was also circulated on social media:</p>
        <p>Furthermore, this screenshot comes from an old WordPress installation of Parler, not from the site’s app. <a href="https://twitter.com/MikaelThalen/status/1331381431155580930" target="_blank" rel="noopener">Tech reporter Mikael Thalen</a> noted that while this WordPress site may have once been used for simple blog posts, like announcements about the new social media site, it did not host any user data.</p>
        <p>Parler CEO John Matze <a href="https://archive.vn/Dwx43" target="_blank">disputed the rumors</a> that his social media site was hacked, writing that “we do not use WordPress products, nor WordPress databases.”</p>
        <p>As of this writing, there’s no evidence to show that any user data, including Social Security numbers or private messages, were hacked from Parler. This rumor originated with a seemingly baseless claim that was subsequently propped up by a months-old screenshot. Furthermore, the CEO of the company has called all of these allegations fake.&nbsp;</p>
