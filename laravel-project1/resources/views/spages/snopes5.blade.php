...
<h1 class="title" style="text-align: center">
	<b>Can WD-40 Fix Cracked Phone Screens?</b></h1>



	<h2 class="subtitle">
		Pictures of WD-40 cans pointed at cracked phone screens have appeared for years in YouTube thumbnails and online advertisements. 	
    </h2>
	...
	<div class="card mb-3">
		...
		<div class="claim-text card-body">
			WD-40 fixes glass on cracked phone screens.
		</div>
	</div>
	<br>
	<div class="card mb-3">
	...
	<div class="single-body card card-body rich-text">
		<p>Right off the bat, no, WD-40 cannot fix the glass on a cracked phone screen. It doesn’t matter if it’s an iPhone, Android, flip phone, or really any kind of phone. In fact, people might find more use for WD-40 on an old candlestick telephone to loosen up some of the parts for repairs than for any modern device.</p>
        <p>The idea that WD-40 can magically fix a cracked phone screen has been featured for quite some time in a number of YouTube thumbnails and online advertisements. It’s also been discussed on online forums.</p>
        <p>Neither video ended up showing how cracked phone screens can be repaired with WD-40. They simply showed that black marker can perhaps be removed from phone screens. It’s unclear if accidentally marking on a phone screen with a Sharpie is a big issue in today’s society.</p>
        <p>Readers who clicked on the ad were led to a 43-page story that never mentioned phones at all. We noticed that one of the ads that appeared under the story claimed that “Hercules” actor Kevin Sorbo died in 2020. This was false, as we previously reported.</p>
        <p>The WD-40 thumbnails and ads might remind some readers of similarly strange travel ads that we’ve reported on in the past. The travel ads claimed that hotel guests should “always” put a towel under the door. Another said guests should “always” place coins in the bathroom sink. These both turned out to be fairly dubious.</p>
        <p>In sum, we don’t recommend turning to a can of WD-40 to fix a cracked phone screen. The best bet is to contact a local retailer or trusted website that specializes in phone repair.</p>
	</div>
		</article>
