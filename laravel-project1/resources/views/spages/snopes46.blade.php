...
<h1 class="title" style="text-align: center">
	<b>Was a Scientist Jailed After Discovering a Deadly Virus Delivered Through Vaccines?</b></h1>



	<h2 class="subtitle">
		/* A short-lived fake story about the giant tech company illustrated the dangers of sharing posts blindly. 	</h2> */
	...
	<div class="card mb-3">
        ...
        <div class="single-body card card-body rich-text" data-component="content-body">

<p>In 2009, biologist Judy Mikovits, who was then the research director of the Chronic Fatigue Syndrome-focused Whittemore Peterson Institute (WPI), <a href="http://science.sciencemag.org/content/326/5952/585" target="_blank" rel="noopener noreferrer">published</a> a paper on what she and many others thought to be a major scientific breakthrough in the prestigious journal <i>Science</i>. Her team alleged to have demonstrated an association between a newly discovered retrovirus called “xenotropic murine leukemia virus-related virus” (XMRV) and the poorly understood condition known as Chronic Fatigue Syndrome (CFS), suggesting a potential viral cause for CFS.</p>
<p>The paper received substantial international coverage. However, as with so many other potentially groundbreaking studies, nobody — including many of the same researchers involved with the original study — was able to replicate its results. Numerous attempts failed to replicate the study, and the research itself came under increasing scrutiny for sloppy methods and its reliance on misleading or manufactured figures.</p>
<p>On 1 July 2011, <i>Science</i>’s editors <a href="http://science.sciencemag.org/content/333/6038/35.1" target="_blank" rel="noopener noreferrer">issued</a> a “statement of concern” about the paper. On 14 October 2011, the authors issued a <a href="http://science.sciencemag.org/content/334/6053/176.1" target="_blank" rel="noopener noreferrer">partial retraction</a> of their paper that touched on issues with some of their figures. Finally, on 23 December 2011, the editors of <i>Science</i> <a href="http://science.sciencemag.org/content/334/6063/1636.1" target="_blank" rel="noopener noreferrer">retracted</a> the paper in full:</p>
<blockquote><p><i>Science</i> is fully retracting the Report “Detection of an infectious retrovirus, XMRV, in blood cells of patients with chronic fatigue syndrome”. Multiple laboratories, including those of the original authors, have failed to reliably detect xenotropic murine leukemia virus– related virus (XMRV) or other murine leukemia virus (MLV)–related viruses in chronic fatigue syndrome (CFS) patients. In addition, there is evidence of poor quality control in a number of specific experiments in the Report … Given all of these issues, <i>Science</i> has lost confidence in the Report and the validity of its conclusions … We are therefore editorially retracting the Report. We regret the time and resources that the scientific community has devoted to unsuccessful attempts to replicate these results.</p></blockquote>
<p>Three months later, the Whittemore Peterson Institute fired Judy Mikovits amid concerns over the integrity of her work and her collaboration with an outside scientist, as <a href="https://www.nature.com/news/2011/111005/full/news.2011.574.html" target="_blank" rel="noopener noreferrer">reported</a> in the multidisciplinary scientific journal <i>Nature</i>:</p>
<blockquote><p>The scientist behind a study that linked chronic fatigue syndrome to a virus has lost her job and is now facing accusations that she has misrepresented data. Judy Mikovits … was fired on 29 September after she clashed with the institute’s president and co-founder, Annette Whittemore, over the work of another researcher.</p>
<p>The following day, in what seems to be a separate development, a blogger posted a figure from a 2009 paper that Mikovits co-authored in Science <i>alongside</i> one that Mikovits used in a recent presentation. The two figures, which are used to describe different results, look identical, except for the labeling.</p></blockquote><div id="smg-zone-post-body-1" class="smg-zone smg-zone-post-body-1"><div class="smg-zone-group smg-zone-group-single-body-1"><div class="smg-zone-widget smg-zone-widget-ads-placement  ">		<div class="PlacementWrapper smg-placement" data-ad-placement-id="post-body-1">
...
<p>A few months after that, Mikovits was <a href="http://retractionwatch.com/2012/06/16/catching-up-charges-against-cfs-xmrv-researcher-mikovits-charges-dropped-gyres-author-andrulis-publishes-another-paper/" target="_blank" rel="noopener noreferrer">arrested</a> in southern California “on an ‘out of county warrant’ from Washoe County, Nevada, for allegedly taking lab notebooks, a computer, and other material from the Whittemore Peterson Institute in Reno, Nevada, after the WPI fired her.” The arrest came in conjunction with a lawsuit from WPI that sought a restraining order to <a href="http://retractionwatch.com/2011/11/19/chronic-fatigue-syndrome-researcher-judy-mikovits-arrested/" target="_blank" rel="noopener noreferrer">block</a> Mikovits’ destruction of data which they maintained belonged to the institute:</p>
<blockquote><p>After Mikovits was terminated on 29 September, she wrongfully removed laboratory notebooks and kept other proprietary information on her laptop and in flash drives and in a personal e-mail account. WPI, a nonprofit organization that’s based on the campus of the University of Nevada, Reno, also won a temporary restraining order that forbids Mikovits from “destroying, deleting, or altering” any of the related files or data.</p></blockquote>
<p>The charges were <a href="https://www.sciencemag.org/news/2012/06/criminal-charges-dropped-against-chronic-fatigue-syndrome-researcher-judy-mikovits" target="_blank" rel="noopener noreferrer">dropped</a>, not because of the merits of the case, but due to a variety of complicating legal factors related to the family that runs the Whittemore Peterson Institute:</p>
<blockquote><p>On 11 June, the district attorney’s office for Washoe County filed a petition to dismiss the criminal charges against Mikovits without prejudice (which means they can file a related complaint in the future), a clerk to the Justice Court of Reno told <i>ScienceInsider</i>.</p>
<p>Mikovits, who was briefly jailed on the charges, is still defending herself in the civil case, which has taken several bizarre twists, including a judge who had ruled against Mikovits recusing himself. The judge removed himself from the case because he received campaign donations from WPI co-founder Harvey Whittemore, who himself has been criminally charged with making illegal campaign contributions to a federal official …</p>
<p>Assistant District Attorney John Helzer, who filed the dismissal, says Whittemore’s legal troubles factored into his decision. “There’s a lot going on with the federal government and different levels that wasn’t occurring when we first became involved with prosecuting this case,” says Helzer. “And we have witness issues that have arisen.”</p></blockquote>
<h2><b>The “Deep State” Version of the Story</b></h2>
<p>Fast forwarding to 2018, we find that Mikovits has become lionized by the medical conspiracy community, appearing on unreliable websites such as <a href="http://archive.is/VF4BZ" target="_blank" rel="noopener noreferrer">Natural News</a> and giving talks at fringe conferences such as The Truth About Cancer and Autism One, with her claims echoing through the various <a href="http://archive.is/6G11D" target="_blank" rel="noopener noreferrer">clickbait</a> <a href="http://archive.is/pEWXW" target="_blank" rel="noopener noreferrer">factories</a> that regurgitate wholesale content from these dubious organizations. For example, the website “Real Farmacy” <a href="http://archive.is/pEWXW#selection-433.0-463.1" target="_blank" rel="noopener noreferrer">described</a> Mikovits’ saga as follows in a 28 November 2018 post:</p>
<blockquote><p>If you have been following stories in recent years of scientists and researchers who make discoveries that are threatening to the Deep State and the bottom line of Big Pharma, you will have seen the pattern before. Those doctors are often ‘persuaded’ to recant their studies, offered bribes or other benefits to distance themselves from or even destroy their data, and even threatened with jail time or, if a legal case is too difficult to fabricate against them, they may simply be killed.</p>
<p>Such is the tale of molecular biologist Judy A. Mikovits, PhD, in the disturbing true story first detailed in this Natural News article that included the video below of how she was thrown in prison for research that led to the discovery that deadly retroviruses have been transmitted to twenty-five million Americans through human vaccines … It was not long after the implications from the paper became clear and the Deep State saw the threat that was being posed to the vaccine industry that their powerful mechanisms of cover-up, obfuscation, and deception were activated.</p></blockquote>
<p>Astute readers may note that the 2009 paper discussed above did not concern vaccines. Mikovits, following the publication of her since-retracted paper, made a series of unsupported claims that XMRV was the cause of myriad other medical maladies, including autism and cancer, and that XMRV in humans could have its origins in mouse cells used in the vaccine production process — a notion that has been exhaustively <a href="https://www.ncbi.nlm.nih.gov/pubmed/27358491" target="_blank" rel="noopener noreferrer">discredited</a>.</p><div id="smg-zone-post-body-2" class="smg-zone smg-zone-post-body-2"><div class="smg-zone-group smg-zone-group-single-body-2"><div class="smg-zone-widget smg-zone-widget-ads-placement  ">		<div class="PlacementWrapper smg-placement" data-ad-placement-id="post-body-2">
    <div class="Placement-placeholder is-hidden">
        <div class="Placement-loader"></div>
    </div>
    <script type="text/javascript">
...
<p>Much of the material Mikovits used to make her point was also retracted, including a 2006 <a href="https://journals.plos.org/plospathogens/article?id=10.1371/journal.ppat.0020025" target="_blank" rel="noopener noreferrer">paper</a> that alleged to show XMRV was present in human prostate cancer cells but actually produced erroneous results due to laboratory contamination.</p>
<p>An exhaustive body of work, which includes some of the same researchers involved in the original 2009 paper, has discredited any link between XMRV and disease. “The bottom line is we found no evidence of infection with XMRV … These results refute any correlation between these agents and disease,” said co-author Ian Lipkin of Columbia University in a <a href="https://www.eurekalert.org/pub_releases/2012-09/asfm-vnt091312.php" target="_blank" rel="noopener noreferrer">press release</a>.</p>
<p>To suggest that Mikovits’ arrest stemmed from a perceived threat to the vaccine industry or “The Deep State” and not her alleged refusal to return scientific data and equipment to the institute that fired her requires completely ignoring this large body of scientific work while solely relying on the narrative presented by Mikovits in her <a href="https://books.google.com/books?id=Q3WgDgAAQBAJ&amp;printsec=frontcover&amp;dq=Plague:+One+Scientist%E2%80%99s+Intrepid+Search+for+the+Truth+about+Human+Retroviruses+and+Chronic+Fatigue+Syndrome+(ME/CFS),+Autism,+and+Other+Diseases.&amp;hl=en&amp;sa=X&amp;ved=0ahUKEwjn8I749o7fAhXMmq0KHXCYCEoQ6AEIKjAA#v=onepage&amp;q=Plague%3A%20One%20Scientist%E2%80%99s%20Intrepid%20Search%20for%20the%20Truth%20about%20Human%20Retroviruses%20and%20Chronic%20Fatigue%20Syndrome%20(ME%2FCFS)%2C%20Autism%2C%20and%20Other%20Diseases.&amp;f=false" target="_blank">2014 book</a>, <i>Plague: One Scientist’s Intrepid Search for the Truth about Human Retroviruses and Chronic Fatigue Syndrome (ME/CFS), Autism, and Other Diseases</i>.</p>
<p>In the introduction to that work, which entirely ignored her firing from Whittemore, Mikovits alleged that the federal government had threatened to arrest her if she set foot on National Institutes of Health property to participate in the study that attempted to validate her previous work:</p>
<blockquote><p>While I was preparing to return to Dr. Frank Rusetti’s lab in Frederick, Maryland and participate in the multi-center validation study directed by Dr. Ian Lipkin, an email would be sent to Frank by none other than Dr. Tony Fauci, head of the National Institute of Allergy and Infectious Disease. In the email, Fauci stated I could participate in the study, but if I stepped foot on National Institutes of Health property, I would be immediately arrested!</p></blockquote>
<p>Dr. Frank Rusetti is a long-time <a href="http://archive.is/ECBPj" target="_blank" rel="noopener noreferrer">collaborator</a> of Mikovits’. We reached out to Dr. Tony Fauci, the director of the National Institute of Allergy and Infectious Disease at the National Institute of Health, about the existence of the email in which he allegedly threatened Mikovits with arrest, and he told us (via email):</p>
<blockquote><p>I have no idea what she is talking about. I can categorically state that I have never sent such an e-mail to Dr. Ruscetti. I had my IT people here at NIH search all my e-mails and no such e-mail exists. Having said that, I would never make such a statement in an e-mail that anyone “would be immediately arrested” if they stepped foot on NIH property.</p></blockquote>
<p>We also reached out to both Rusetti and Mikovits via their <a href="http://archive.is/ECBPj" target="_blank" rel="noopener noreferrer">consulting website</a> for more information about this alleged email but have not received a response.</p><div id="smg-zone-post-body-3" class="smg-zone smg-zone-post-body-3"><div class="smg-zone-group smg-zone-group-single-body-3"><div class="smg-zone-widget smg-zone-widget-ads-placement  ">		<div class="PlacementWrapper smg-placement" data-ad-placement-id="post-body-3">
    <div class="Placement-placeholder is-hidden">
        <div class="Placement-loader"></div>
    </div>
    <script type="text/javascript">
...
<p>Since <a href="https://www.ncbi.nlm.nih.gov/pubmed/27358491" target="_blank" rel="noopener noreferrer">2016</a>, science has reached the consensus view that the XMRV detected in these various studies was a laboratory contaminant which affected the research cell lines used by the scientists conducting those studies, and that it was not a virus that had been transmitted to humans in any way. In a <a href="https://www.naturalnews.com/2018-06-08-the-criminalization-of-science-whistleblowers-a-mind-blowing-interview-with-judy-mikovits-phd.html" target="_blank" rel="noopener noreferrer">video</a> produced by the conspiracy website Natural News in 2018, however, Mikovits made a series of additional claims that she had been fired and jailed for exposing that millions of Americans had supposedly been infected with viruses “that came from out of labs into humans via contaminated blood and vaccines”:</p>
<blockquote><p>The fact that [these allegedly human-derived viruses] were real was just too much for 25 million Americans are infected with the viruses that came from out of labs into humans via contaminated blood and vaccines. And that was what … so I was fired, jailed without cause, without hearing, without any civil rights at all, just drug out of my house in shackles one day, November 18th 2011.</p></blockquote>
<p>As noted above, Mikovits’ controversial paper did not demonstrate that XMRV “came out of the lab into humans via contaminated blood and vaccines”; rather, it <i>speculated</i> such after seemingly demonstrating a (now discredited) association between XMRV and CFS. To say Mikovits was jailed for exposing widespread virus transmission via vaccines or blood transfusions is false, not only because she was actually jailed for allegedly stealing property, but also because she never scientifically demonstrated the claim she suggests the government wanted to silence her over. In her interview with Natural News, Mikovits stated that the idea for the connection between viruses and vaccines came from another researcher in a paper published in 2011:</p>
<blockquote><p>So in 2011 another AIDS researcher in a journal called Frontiers in Microbiology wrote a paper that really cost me a lot. I didn’t know he was gonna write this paper but it basically said, “The most likely way that these murine leukemia virus related viruses, these types of viruses entered humans was through vaccines.”</p></blockquote>
<p>That <a href="https://www.frontiersin.org/articles/10.3389/fmicb.2010.00147/full#h13" target="_blank" rel="noopener noreferrer">paper</a>, which referenced two other now-retracted papers in its abstract, only presented the vaccine scenario speculatively as a <i>potential</i> route for humans to acquire XMRV:</p>
<blockquote><p>The novel human retrovirus xenotropic murine leukemia virus-related virus (XMRV) is arguably the most controversial virus of this moment. After its original discovery in prostate cancer tissue from North American patients [<i>paper retracted</i>], it was subsequently detected in individuals with chronic fatigue syndrome from the same continent [<i>paper retracted</i>]. However, most other research groups, mainly from Europe, reported negative results …</p>
<p>The detection of integrated XMRV proviruses in prostate cancer tissue [<i>paper retracted</i>] proves it to be a genuine virus that replicates in human cells, leaving the question: how did XMRV enter the human population? We will discuss two possible routes: either via direct virus transmission from mouse to human … or via the use of mouse-related products by humans, including vaccines. We hypothesize that mouse cells or human cell lines used for vaccine production could have been contaminated with a replicating variant of the XMRV precursors encoded by the mouse genome.</p></blockquote>
<p>That study did conclude by opining that the “most likely mode of XMRV transmission points to mouse-derived biological products” and stating that the authors hoped the study would “spur further discussion and help to resolve the many remaining XMRV questions.” But in a <a href="https://www.ncbi.nlm.nih.gov/pubmed/21621147" target="_blank" rel="noopener noreferrer">paper</a> published just five months later titled “XMRV: Not a Mousy Virus”, those <i>same authors</i> walked back claims of XMRV’s prevalence (and even its existence as a true human virus) based on results which called earlier laboratory methods into question:</p>
<blockquote><p>XMRV was discovered in 2006 in tumor tissue from patients with prostate cancer [<i>paper retracted</i>] with a viral genome sequence highly similar to that of mouse xenotropic retroviruses. Sequence analysis suggested that XMRV is a novel recombinant derived from two fragmented endogenous murine viruses integrated in the mouse genome. XMRV was subsequently detected in other prostate cancer tissues and in blood from patients with CFS (chronic fatigue syndrome) [<i>paper retracted</i>].</p>
<p>However, most other studies failed to replicate these findings, especially outside the USA, suggesting either that the virus has a limited geographical spread, or that positive results were due to contamination of biological reagents or human samples with mouse DNA. Four recent papers indeed show that murine DNA sequences can be detected virtually everywhere, and that extreme care should be taken when amplifying XMRV sequences. These results certainly put into serious doubt some of the high prevalence results and proposed disease associations that could not be confirmed by others.</p></blockquote><div id="smg-zone-post-body-4" class="smg-zone smg-zone-post-body-4"><div class="smg-zone-group smg-zone-group-single-body-4"><div class="smg-zone-widget smg-zone-widget-ads-placement  ">		<div class="PlacementWrapper smg-placement" data-ad-placement-id="post-body-4">
    <div class="Placement-placeholder is-hidden">
        <div class="Placement-loader"></div>
    </div>
    <script type="text/javascript">
        smg.ads.load( 'post-body-4' );
    </script><div class="Placement">
<zeus-ad id="zeus_post-body-4" data-adunitpath="/{{gamId}}/{{slotId}}" data-slot="/1005222/post-body-4" aria-hidden="true" data-renderbehavior="lazy" data-refresh="true" data-json="{&quot;targeting&quot;:{&quot;zeus_rendercount&quot;:&quot;1&quot;,&quot;zeus_slot&quot;:&quot;zeus_post-body-4.init.dsk&quot;}}" style="margin: auto; width: 1px; display: block;"></zeus-ad>
</div>
</div>
</div></div></div>
<p>Further research <a href="https://www.ncbi.nlm.nih.gov/pubmed/27358491" target="_blank" rel="noopener noreferrer">determined</a> that all XMRV samples detected in these studies stemmed from a contaminated cell line affecting all the labs performing these studies, that it did not cause disease, and that it did not enter the population via vaccines or blood transfusions:</p>
<blockquote><p>Molecular biologists traced the development of XMRV to a recombination event in a laboratory mouse that likely occurred circa 1993. The virus was propagated via cell lines derived from a tumor present in this mouse and spread through contamination of laboratory samples. Well-controlled experiments showed that detection of XMRV was due to contaminated samples and was not a marker of or a causal factor in prostate cancer or CFS.</p></blockquote>
<p>Therefore, Mikovits’ speculative claims linking her research to vaccine science, drawing the ire of “Big Pharma” and the “Deep State”, and her subsequent arrest are not rooted in science or reality. But although she may have lost the support of the scientific community, she appears to have found a new home in the pseudoscientific conspiracy world.</p>
<p>“In the United States of America … everything’s censored,” Mikovits said on the <a href="https://www.naturalnews.com/2018-06-08-the-criminalization-of-science-whistleblowers-a-mind-blowing-interview-with-judy-mikovits-phd.html" target="_blank" rel="noopener noreferrer">website</a> of a man who guest hosts Alex Jones’ <i>Infowars</i> conspiracy ranting, “so to look at things like Natural News, to come to meetings like The Truth About Cancer, I was just floored today because today was the first time I was treated like a human being who had knowledge for a very long time.”</p>
<p>In 2020, Mikovits was featured in a film called “Plandemic” that supposedly exposed “the hidden agenda behind the COVID-19” coronavirus disease pandemic.</p>
