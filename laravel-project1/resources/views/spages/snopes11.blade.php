...
<h1 class="title" style="text-align: center">
	<b>Are These Really Robots Ballroom Dancing at Shanghai Disneyland?</b></h1>



	<h2 class="subtitle">
		Not even the combined forces of Disney and Chinese technology could manufacture raw talent. 	</h2>
	...
	<div class="card mb-3">
		...
		<div class="claim-text card-body">
			...
			A video accurately depicts robot ballroom dancers created in China, performing at the Shanghai Disneyland Resort. The robots are human-like, with realistic facial expressions and movement.
		</div>
	...
	<div class="single-body card card-body rich-text">
        ...
        <p>Chinese-manufactured robots are very popular on the internet for their many impressive and <a href="https://qz.com/1043470/robot-women-in-asia-now-have-human-stylists/" target="_blank" rel="noopener noreferrer">lifelike</a> <a href="https://www.bbc.co.uk/news/av/world-asia-china-37019690" target="_blank" rel="noopener">feats</a>, but one story really took us for a spin. A <a href="https://twitter.com/tulioagomez/status/1303162293719531520?lang=en" target="_blank" rel="noopener noreferrer">video</a> of a pair of ballroom dancers went viral, with many claiming that the performers were not real, but were in fact robots created in China that were performing at the Shanghai Disneyland resort.</p>
        <p>Snopes readers sent us the same video of the couple dancing, with the woman in a white dress and her partner in coattails. Many asked us to confirm if they were, indeed, robots. You can watch the video, tweeted by the verified account of an Indian politician and actor, below:</p>
        <p>The tweet claims that these dancers were “robots made in China,” and this five minute performance was broadcast at Shanghai Disneyland. The <a href="https://twitter.com/CarlosEstefan1/status/1302045025539416064" target="_blank" rel="noopener">same language</a> has been circulating in <a href="https://twitter.com/looloo20000000/status/1307264310209634305" target="_blank" rel="noopener">others’</a> tweets when sharing this video.&nbsp;</p>
        <p>The origin of this performance was actually a 2013 clip from British television show “Strictly Come Dancing” that aired on BBC One. The performers were Abbey Clancy and Aljaž Škorjanec, who were dancing the Viennese waltz. You can see the performance shared from the official BBC YouTube account:</p>
        <p>This false rumor is similar to another one from <a href="https://www.thequint.com/news/webqoof/video-of-chinese-dancer-falsely-shared-as-shanghai-disney-robot" target="_blank" rel="noopener">2019</a> that claimed Chinese classical dancer Qin Xi was actually a robot performing at Shanghai’s Disneyland.</p>
        <p>Given that the actual video shows two very real people dancing on a British television show, and not two robots, we rate this claim as “False.”</p>
	</div>
		</article>
