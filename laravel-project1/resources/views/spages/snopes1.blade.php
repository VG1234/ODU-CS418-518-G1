...
<h1 class="title" style="text-align: center">
	<b>‘Alexa, What Will Happen to Florida in 2025?’</b></h1>



	<h2 class="subtitle">
		Alexa, why can't you predict the future? 	</h2>
	...
	<div class="card mb-3">
		...
		<div class="claim-text card-body">
			...
			Amazon's voice assistant, Alexa, predicted that Miami will be completely destroyed by a hurricane in 2025.
		</div>
