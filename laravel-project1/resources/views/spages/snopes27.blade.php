...
<h1 class="title" style="text-align: center">
	<b>Is an Asteroid Expected to Hit the Day After Valentine’s Day 2020?</b></h1>
	...
	<div class="card mb-3">
		...
		<div class="claim-text card-body">
            An asteroid is expected to hit earth in mid-February 2020.
...
<p>In February 2020, numerous social media users were concerned about a potentially “planet-killing” asteroid that supposedly was expected to hit earth on the day after Valentine’s Day. As is typical for this type of “armageddon” rumor, fears about this doomsday event were overblown and largely based on fear-mongering headlines:</p>
<p>International Business (IBT) Times published an <a href="https://www.ibtimes.com/largest-planet-killer-asteroid-approach-earth-month-arriving-saturday-2921210" target="_blank" rel="noopener noreferrer">article</a> headlined: “Largest Planet-Killer Asteroid To Approach Earth This Month Arriving On Saturday.”</p>
<p>The Express <a href="https://www.express.co.uk/news/science/1241788/NASA-asteroid-alert-radars-track-space-rock-close-approach-Earth-asteroid-news" target="_blank" rel="noopener noreferrer">claimed</a>: “NASA asteroid alert: Radars track a 20,000MPH space rock on ‘close approach’ this weekend.”</p>
<p>All of these articles are somewhat based in reality. NASA monitors the skies for NEOs (near-earth objects), and a large asteroid was indeed approaching earth in February 2020. However, these articles led many people to believe their lives were in danger, and that the asteroid was expected to hit earth. But that simply isn’t the case.&nbsp;</p>
<p>While these articles spend time talking about what would happen if a large asteroid actually made impact with the earth (complete with pictures of cinematic doomsday events), they all concede in their concluding paragraphs that this asteroid (asteroid 163373 or 2002 PZ39) won’t come within <em>3</em> <em>million</em> <em>miles</em> of earth.&nbsp;</p><div id="smg-zone-post-body-1" class="smg-zone smg-zone-post-body-1"><div class="smg-zone-group smg-zone-group-single-body-1"><div class="smg-zone-widget smg-zone-widget-ads-placement  ">		<div class="PlacementWrapper smg-placement" data-ad-placement-id="post-body-1">
...
<p>IBT writes (emphasis ours): “According to [NASA’s Center for Near-Earth Object Studies], 163373 (2002 PZ39)’s near-Earth intersection will happen on Feb. 15 at 6:05 a.m. EST. <strong>During this time, the asteroid will pass over the planet from a distance of 0.03860 astronomical units or around 3.6 million miles away.</strong>”</p>
<p>NASA confirmed this to us in a statement, writing:</p>
<p>“The trajectory of asteroid 2002 PZ39 is very well known. It will pass by Earth at a distance of about 5.77 million kilometers (approximately 3.59 million miles). The asteroid will approach no closer than about 15 times the distance of the Moon.”</p>
<p>The Center for Near-Earth Object Studies (CNEOS) is constantly monitoring the skies for potentially dangerous asteroids. In fact, CNEOS currently <a href="https://cneos.jpl.nasa.gov/ca/" target="_blank" rel="noopener noreferrer">lists</a> about 20 asteroids that will pass safely by earth over the next month. Only one, a relatively small asteroid with an estimated diameter of about of 50 meters called asteroid 2018 GY, is expected to come within 1 million miles of earth.&nbsp;</p>
<p>Here’s a little more information about near-earth objects from <a href="https://cneos.jpl.nasa.gov/about/target_earth.html" target="_blank" rel="noopener noreferrer">CNEOS </a>(emphasis ours):&nbsp;</p>
<blockquote><p>On a daily basis, about one hundred tons of interplanetary material drifts down to the Earth’s surface. Most of the smallest interplanetary particles that reach the Earth’s surface are the tiny dust particles that are released by comets as their ices vaporize in the solar neighborhood. The vast majority of the larger interplanetary material that reaches the Earth’s surface originates as the collision fragments of asteroids that have run into one another some eons ago.</p>
...
<p><strong>… No one should be overly concerned about an Earth impact of an asteroid or comet.</strong> The threat to any one person from auto accidents, disease, other natural disasters and a variety of other problems is much higher than the threat from NEOs. Over long periods of time, however, the chances of the Earth being impacted are not negligible so that some form of NEO insurance is warranted. At the moment, our best insurance rests with the NEO scientists and their efforts to first find these objects and then track their motions into the future. We need to first find them, then keep an eye on them.</p></blockquote>
<p>This is hardly the first time we’ve received questions about a potential “earth-killing” asteroid. In fact, we’ve been <a href="https://www.snopes.com/fact-check/asteroid-hit-earth-on-christmas/" target="_blank" rel="noopener noreferrer">investigating</a> rumors about <a href="https://www.snopes.com/fact-check/will-a-doomsday-asteroid-destroy-earth-in-february-2017/" target="_blank" rel="noopener noreferrer">doomsday</a> asteroids since at least <a href="https://www.snopes.com/fact-check/asteroid-christmas-eve/" target="_blank" rel="noopener noreferrer">2015</a>. These fear-inducing reports have all come and gone without incident, and we expect that asteroid 2002 PZ39 will do the same.&nbsp;</p>
