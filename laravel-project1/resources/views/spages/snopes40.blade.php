...
<h1 class="title" style="text-align: center">
	<b>Are Scientists ‘Literally Creating Glow-in-the-Dark Trees’ With Firefly DNA?</b></h1>



	<h2 class="subtitle">
		A TikTok video made an impressive number of false statements in 15 seconds.	</h2>
	...
	<div class="card mb-3">
		...
		<div class="claim-text card-body">
			...
			Dutch scientists literally created glow-in-the-dark trees by inserting genetic material from fireflies, making them "eco-friendly outdoor nightlights."
		</div>
...
<p>In a Jan. 30, 2021, <a href="https://www.tiktok.com/@niklongo/video/6923404321753238790?_d=secCgYIASAHKAESMgowbKTW5l9MHyeZe7zXE3Nx95EFjr%2F1ZuooWB4hT8GDG2%2B0AWBlbFxLvEn8fgUfR8GhGgA%3D&amp;language=en&amp;preview_pb=0&amp;sec_user_id=MS4wLjABAAAAqdeV2laPsULf_cVtFtvu1WURemquyEAnuJ8vAMVSJ63W41ZaWjk5kB0fsy9YDc2F&amp;share_item_id=6923404321753238790&amp;share_link_id=AF595902-C6AF-4D95-9EEC-282BC867FE9D&amp;timestamp=1612203146&amp;tt_from=copy&amp;u_code=ddjf3la4djm435&amp;user_id=6856094688577242118&amp;utm_campaign=client_share&amp;utm_medium=ios&amp;utm_source=copy&amp;source=h5_m&amp;is_copy_url=1&amp;is_from_webapp=v1" target="_blank" rel="noopener noreferrer">TikTok video</a>, user niklongo blew the minds of his collective audience with a purported scientific development by Dutch scientists:</p>
<blockquote><p>You wanna have your mind blown?</p>
<p>Dutch scientists have located and isolated the gene that makes fireflies able to glow, recombined the DNA, and put that DNA in plants, literally creating glow-in-the-dark trees. Eco-friendly outdoor nightlights!</p>
<p>Follow for more!</p></blockquote>
<p>Broadly speaking, these claims stem primarily from confused and overhyped reporting that, at the time of the TikTok video, was over six years old. While scientists have inserted genes into plants that create a faint glow, glowing trees remain theoretical. The imagery used in the video stems from artwork inspired by — but not created with — this largely theoretical technology. Below, we break down all the problems with the assertions in the video:</p>
<h4>‘Dutch Scientists’</h4>
<p>Two words in, and already we are in trouble. The video asserts that “Dutch scientists” are responsible for locating and isolating the gene that “makes fireflies able to glow.” This is incorrect. The video’s Dutch connection is an artist and designer named <a href="https://www.studioroosegaarde.net/info" target="_blank" rel="noopener noreferrer">Daan Roosegaarde</a> who did not actually locate or isolate any genes, or put said genes in a tree. Some of the images used in the TikTok video were created by Roosegaarde, but these were created by literally shining lights on trees as part of an art installation called “Glowing Nature.”</p><div id="smg-zone-post-body-1" class="smg-zone smg-zone-post-body-1"><div class="smg-zone-group smg-zone-group-single-body-1"><div class="smg-zone-widget smg-zone-widget-ads-placement  ">		<div class="PlacementWrapper smg-placement" data-ad-placement-id="post-body-1">
...
<p>In 2014, Roosegaarde received a splash of U.S. media coverage while promoting his work at that year’s SXSW festival in Austin, TX. During <a href="https://vimeo.com/89651857" target="_blank" rel="noopener noreferrer">an interview</a> in which he discussed using biologically inspired technology to solve environmental problems, he explained that the idea of using glowing trees as street lamps was inspired in part by the work of former SUNY Stony Brook professor Alexander Krichevsky, who in 2011 left his academic post to start <a href="https://web.archive.org/web/20160520052646/http://bioglowtech.com:80/about.html" target="_blank" rel="noopener noreferrer">a company</a> named Bioglow. The company “developed the world’s first autoluminescent (light producing) plants,” according to an archived version of the company’s website.</p>
<div style="max-width: 1333px;">
<div style="left: 0; width: 100%; height: 0; position: relative; padding-bottom: 56.25%;"><iframe title="Daan Roosegaarde, SXSW 2014" src="https://streamable.com/o/o1ocd4" style="border: 0; top: 0; left: 0; width: 100%; height: 100%; position: absolute;" allowfullscreen="" scrolling="no" allow="encrypted-media"></iframe></div>
</div>
<p>Bioglow apparently no longer exists, but it did produce and sell a limited run of faintly glowing plants. Unlike the imagery shown in the TikTok, the glowing effect in these plants was significantly more modest. “Some people … over 40 may not be able to see the glow,” explained a Bioglow promotional <a href="http://bioglow.us/pages/product-info/" target="_blank" rel="noopener noreferrer">video</a> from August 2015:</p>
<div style="max-width: 1333px;">
<div style="left: 0; width: 100%; height: 0; position: relative; padding-bottom: 56.25%;"><iframe title="BioGlow Explainer" src="https://streamable.com/o/t8380u" style="border: 0; top: 0; left: 0; width: 100%; height: 100%; position: absolute;" allowfullscreen="" scrolling="no" allow="encrypted-media"></iframe></div>
</div>
<p>In the 2014 SXSW <a href="https://vimeo.com/89651857" target="_blank" rel="noopener noreferrer">video</a>, Roosegaarde held one of these early Bioglow plants as an example of biomimicry that inspires his art. Several reporters apparently <a href="https://www.dogonews.com/2014/4/19/dutch-designer-aspires-to-replace-street-lights-with-glow-in-the-dark-trees" target="_blank" rel="noopener noreferrer">falsely</a> <a href="https://www.huffpost.com/entry/daan-roosegaarde_n_5044578" target="_blank" rel="noopener noreferrer">concluded</a> that the Bioglow plant was an invention that Roosegaarde conceived of and helped to develop. This does not appear to be accurate. While <a href="https://www.theverge.com/2014/3/14/5504656/a-natural-glow-these-plants-produce-their-own-light-bioglow-daan-roosegarde" target="_blank">some reports</a> suggested there were or are theoretical plans for the artist and the scientist to collaborate on “a really large [autoluminescent plant] like a tree which glows at night instead of standard street lighting,” there is no indication anything came of this collaboration, if it materialized at all.</p>
<p>Contact information for Krichevsky was not readily apparent. We reached out to Roosegaarde’s studio for more information on their work together and will update our piece if we receive new information.&nbsp;</p>
<h4>‘The Gene That Makes Fireflies Able To Glow’</h4>
<p>Contrary to the claim in the TikTok video, the creation of genetically modified glowing plants does not, at any point, introduce genes sourced from fireflies. Part of the confusion is that several academic or commercial enterprises are attempting, or have attempted, to create glowing plants. All of these efforts involve, in some way, the chemical luciferase, which reacts with a group of chemicals termed luciferins in a way that generates light. This chemical mechanism, generally speaking, is <a href="https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0015461" target="_blank" rel="noopener noreferrer">responsible</a> for bioluminescence in several organisms, including fireflies.</p><div id="smg-zone-post-body-2" class="smg-zone smg-zone-post-body-2"><div class="smg-zone-group smg-zone-group-single-body-2"><div class="smg-zone-widget smg-zone-widget-ads-placement  ">		<div class="PlacementWrapper smg-placement" data-ad-placement-id="post-body-2">
    <div class="Placement-placeholder is-hidden">
        <div class="Placement-loader"></div>
    </div>
    <script type="text/javascript">
...
<p>Several glowing plant projects attempt to create luminescence by directly injecting or applying luciferins and luciferase into or on them. One of the most <a href="https://news.mit.edu/2017/engineers-create-nanobionic-plants-that-glow-1213" target="_blank">notable efforts</a> using this sort of methodology comes from the laboratory of Michael Strano, a professor of chemical engineering at MIT developing a nanoparticle delivery mechanism. These efforts have also received significant (and more recent) media <a href="https://www.dailymail.co.uk/sciencetech/article-5178531/MIT-creates-bioluminescent-trees-glow-like-fireflies.html" target="_blank">coverage</a>, but this work is not actually genetic engineering.</p>
<p>As far as we are aware, the only person to attempt to use genetic engineering to create glowing plants is Krichevsky. The central difference in his approach compared to those that apply luciferin-related chemicals is that Krichevsky’s plants are autoluminescent. In other words, he modified the genes of a plant in a way that allows it <a href="https://web.archive.org/web/20160520052646/http://bioglowtech.com:80/about.html" target="_blank">to create</a> <em>its own</em> luciferins and luciferase.</p>
<p>However, the genetic material inserted into the plant’s genome does not come from fireflies. Krichevsky published his methodology for engineering his plants in a 2010 <a href="https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0015461" target="_blank">paper</a>. The genes it uses are sourced from the bioluminescent marine bacteria Photobacterium leiognathi. In neither method would it be accurate to say genes are isolated “from fireflies.”</p>
<h4>‘Literally Creating Glow-in-the-Dark Trees’</h4>
<p>A commonly invoked vision for people involved in glowing plant research is a future where energy consumption is reduced thanks to glowing trees that could serve as self-powered streetlamps.</p>
<p>Speaking to the outlet Dezeen in 2014, Krichevsky <a href="https://www.dezeen.com/2014/01/13/worlds-first-glow-in-the-dark-plant-genetically-engineered/" target="_blank" rel="noopener noreferrer">explained</a>, “In the long term we see use of glowing plants in contemporary lighting design, namely in landscaping and architecture as well as in transportation, marking driveways and highways with natural light that does not require electricity.”</p>
<p>In an <a href="https://www.dezeen.com/2014/03/24/movie-sxsw-daan-roosegarde-glow-in-dark-trees/" target="_blank" rel="noopener noreferrer">article</a> introducing his SXSW interview a few months later, Dezeen introduced Roosegaarde as someone “exploring ways of using bioluminescent bacteria found in jellyfish and mushrooms to create glow-in-the-dark trees that could replace street lights.”</p>
<p>“Our target is to perform one treatment when the plant is a seedling or a mature plant, and have it last for the lifetime of the plant,” Strano <a href="https://news.mit.edu/2017/engineers-create-nanobionic-plants-that-glow-1213" target="_blank" rel="noopener noreferrer">said</a> in the 2017 MIT Press release. “Our work very seriously opens up the doorway to streetlamps that are nothing but treated trees, and to indirect lighting around homes.”</p>
<p>In none of these cases, however, did these individuals literally create a glowing tree. The technology simply is not there yet. Krichevsky’s plants were not trees, but instead modified <a href="https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0015461" target="_blank" rel="noopener noreferrer">tobacco plants</a>, which are commonly used in genetic research. The imagery used in the TikTok video comes from either art installations made by Roosegaarde which only mimicked the technology, or from computer-generated concept art, not literal glowing trees. Sadly.</p>
<p>Because glowing trees do not (yet) exist, because firefly genes are not used in this area of research, and because the work is falsely attributed to “Dutch scientists,” the claims presented in niklongo’s TikTok are “False.”</p>
