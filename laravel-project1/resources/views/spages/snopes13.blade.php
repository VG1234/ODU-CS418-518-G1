...
<h1 class="title" style="text-align: center">
	<b>Is Facebook Charging a User Fee?</b></h1>



	<h2 class="subtitle">
		Some rumors never die — they just grow new head. 	</h2>
	...
	<div class="single-body card card-body rich-text">
        <p>In May 2020, an old social media hoax that Snopes has been shooing off the porch for more than a decade came back around again.</p>
        <p>Several readers sent us screenshots of the following text, which claimed that Facebook was becoming “chargeable” (red flag #1: bad grammar). If users wanted their accounts to “remain free” and avoid being billed 0.01 per message, they must, according to the text, forward the message to 10 contacts (red flag #2: good advice doesn’t usually require being shared to a specific number of people):</p>
        <p><a href="https://www.snopes.com/tachyon/2020/05/MemeOverlay_vertical12.png"><img loading="lazy" class="aligncenter wp-image-250809" src="https://www.snopes.com/tachyon/2020/05/MemeOverlay_vertical12.png" alt="From saturday morning facebook will become chargeable" width="700" height="992" data-recalc-dims="1" srcset="https://www.snopes.com/tachyon/2020/05/MemeOverlay_vertical12.png?resize=1200%2C1700&amp;zoom=1 1200w, https://www.snopes.com/tachyon/2020/05/MemeOverlay_vertical12.png?resize=1200%2C1700&amp;zoom=0.5 600w, https://www.snopes.com/tachyon/2020/05/MemeOverlay_vertical12.png?resize=1200%2C1700&amp;zoom=0.25 300w" sizes="(max-width: 1200px) 100vw, 1200px"></a>We hope no one spent any time looking for little blue lights, because this message is complete nonsense. (Red flag #3: The paper? What year is this?)</p>
        <p>It was nearly identical to one example included in a rolling <a href="https://www.snopes.com/fact-check/facebook-implementing-user-fees/" target="_blank" rel="noopener noreferrer">fact check</a> that we originally published in December 2009 and have updated many times since as different variations of this hoax have emerged over time.</p>
        <p>We rate the newer variation as False, again, because, if Facebook — one of the most widely used sites in the history of the internet — had reversed course on its longstanding promise to remain a free site, it would have probably been mentioned somewhere on its website or on the internet at large. We found no such announcement.</p>
        <p>It may be worth noting that the 0.01 price could conceivably have some tie to reality, but not in the context of Facebook charging user fees.</p>
        <p>On April 24, 2020, Facebook announced it was rolling out or expanding several features, among them the option for users to send video creators some “stars” while they are live streaming. (Imagine sending a video blogger you like a 1-cent tip per “like” — generous!) But that transaction would be optional, and the money would be sent to the content creator (it’s unclear what, if any, “cut” Facebook receives per star sold). It’s not the same as charging a user a per-message fee to use Facebook.</p>
        <p>Although Facebook has recently announced plans to expand opportunities for publishers and creators to monetize certain content or raise donations on Facebook, that doesn’t appear to change the fact that users can still generally use Facebook’s basic platform tools for free (unless users really want to offer money).</p>
