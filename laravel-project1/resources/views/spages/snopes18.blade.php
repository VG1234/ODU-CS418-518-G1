...
<h1 class="title" style="text-align: center">
	<b>Does Facebook’s Green ‘BFF’ Prove Your Account Is Secure?</b></h1>



	<h2 class="subtitle">
		A Facebook status update meme claims that a green "BFF" in typed comments is an indicator of account security; it isn't.	</h2>
...
<p>In March 2018, a Facebook status update meme began circulating across social networks:</p>
<p>The origin of the claim remains unclear, but like many other rumors about <a href="https://www.snopes.com/fact-check/facebook-implementing-user-fees/" target="_blank" rel="noopener">Facebook features</a>, it spread far and fast. And like most of those assertions, it appeared to be based on a completely inaccurate <a href="https://www.snopes.com/fact-check/facebook-paying-spies/" target="_blank" rel="noopener">inference</a> about the site’s features.</p>
<p>On 23 October 2017, Mashable <a href="https://mashable.com/2017/10/23/facebook-words-hidden-animations/#U.evn9MT6aql" target="_blank" rel="noopener">reported</a> Facebook’s introduction of a then-new feature involving words in comments that triggered animations. Among them were “congratulations,” “xoxo,” and “BFF” (best friends forever):</p>
<p>Now, Facebook is updating the list of words that triggers these animations. Additions include: “rad,” “bff,” “lmao,” and “thank you so much.” All of those words will now come with their own colors and animation effects.</p></blockquote>
<p>In the video below, the animation for “BFF” begins at approximately the 0:27 mark:</p>
<p></p><center><iframe src="https://www.youtube.com/embed/d_pNBekLyxo?rel=0&amp;start=27" width="560" height="315" frameborder="0" allowfullscreen="allowfullscreen"></iframe></center><br>
