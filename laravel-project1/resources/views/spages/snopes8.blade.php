...
<h1 class="title" style="text-align: center">
	<b>Did Apple Block Directions to US Capitol?</b></h1>



	<h2 class="subtitle">
		The theory is belied by the fact that Apple Maps provides directions to Washington, D.C. 	</h2>
...
<p>On Jan. 5, 2021, several pro-Trump pundits began tweeting a rumor that Apple disabled their iPhone’s map application from providing directions to Washington, D.C., implying it was an attempt by the company to suppress participation in protests planned to coincide with Congressional certification of the 2020 U.S. presidential election:</p>
<p>We reached out to Apple on Twitter, but have not yet received a response to our inquiry about this rumor. 

Regardless, there is no evidence that the screenshots, if authentic, represent anything other than a bug or user error.</p>
<p>Stephanie Hamill, an OANN host, tweeted that “it’s now working” an hour after claiming Apple maps was blocking her from getting directions to D.C., for example. That the issue corrected itself suggests no intent on the part of Apple to block information due to the protests. </p>
<p>At the time of this reporting, a day later, we have had no problem getting directions to the nation’s capital with Apple Maps, even as a curfew descends on the city following an <a href="https://archive.vn/1CwKn" target="_blank">unprecedented riot</a> that saw members of Congress evacuated from their chambers.</p>
<p>If the notifications shown in these tweets are genuine, one potential <a href="https://archive.vn/z6Qty#selection-5363.0-5363.111" target="_blank">explanation</a> is that the pin location used is placed on, or defaulted to, one of the many roads closed in anticipation of the protests. If so, such a bug appears to have resolved itself by <a href="https://archive.vn/cZDV4" target="_blank">4:43 p.m.</a> EST on Jan 5. 2021, well before the protests began. As such, we rank the claim “False.”</p>
