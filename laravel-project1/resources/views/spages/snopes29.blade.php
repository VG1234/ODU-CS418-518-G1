...
<h1 class="title" style="text-align: center">
	<b>Did a Mural of Greta Thunberg Use 700 Gallons of Spray Paint?</b></h1>



	<h2 class="subtitle">
		A right-leaning social media activist grossly exaggerated the environmental impact of a San Francisco mural in honor of the climate change activist. 	</h2>
	...
	<ul class="list-unstyled authors list-unstyled d-flex flex-wrap comma-separated">
							...
							<li>
					<a class="font-weight-bold" href="https://www.snopes.com/author/alex/">
						Author: Dan MacGuill					
                    </a>
				</li>
...
<p>In November 2019, we received multiple inquiries from readers about widely shared social media posts claiming irony or hypocrisy at work in the production of a massive San Francisco mural in honor of the young climate activist Greta Thunberg.&nbsp;</p>
<p>On Nov. 8, the right-leaning social media activist Brandon Straka tweeted a link to a KPIX-TV article about the mural, adding his own view that, “The leftist geniuses in San Francisco have decided to send a message about climate change by creating a 6 story [sic] mural of Greta Thunberg using 700 gallons of aerosol spray paint.”</p>
<blockquote class="twitter-tweet" data-twitter-extracted-i1638676473295678066="true">
<p dir="ltr" lang="en">The leftist geniuses in San Francisco have decided to send a message about climate change by creating a 6 story mural of Greta Thunberg using 700 gallons of aerosol spray paint. 🤣 <a href="https://t.co/LdJj2i3j99" target="_blank">https://t.co/LdJj2i3j99</a></p>
<p>— Brandon Straka (@BrandonStraka) <a href="https://twitter.com/BrandonStraka/status/1193014357782867968?ref_src=twsrc%5Etfw" target="_blank">November 9, 2019</a></p></blockquote>
<p><script async="" src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>&nbsp;</p>
<p>The text of Straka’s tweet, and screenshots of it, were further promulgated by <a href="http://archive.is/LHQiZ" target="_blank">multiple</a> <a href="http://archive.is/8dbGg" target="_blank">users</a> on <a href="http://archive.ph/gZGDN" target="_blank">Facebook</a>. The KPIX-TV article to which he linked did not contain any reference to the paint used by Argentinian artist Andrés Pereoselli (known as “Cobre”) in creating the Thunberg mural. As such, it did not provide any evidence to support Straka’s key claim, that the portrait of the climate activist required 700 gallons of aerosol spray paint.&nbsp;</p><div id="smg-zone-post-body-1" class="smg-zone smg-zone-post-body-1"><div class="smg-zone-group smg-zone-group-single-body-1"><div class="smg-zone-widget smg-zone-widget-ads-placement  ">		<div class="PlacementWrapper smg-placement" data-ad-placement-id="post-body-1">
...
<zeus-ad id="zeus_post-body-1" data-adunitpath="/{{gamId}}/{{slotId}}" data-slot="/1005222/post-body-1" aria-hidden="true" data-renderbehavior="lazy" data-refresh="true" data-json="{&quot;targeting&quot;:{&quot;zeus_rendercount&quot;:&quot;3&quot;,&quot;zeus_slot&quot;:&quot;zeus_post-body-1.ref.dsk&quot;}}" style="margin: auto; width: 300px; display: block;" data-google-query-id="CKvmu9vhy_QCFdgJaAgdGrYJZw"><div id="google_ads_iframe_/1005222/post-body-1_0__container__" style="border: 0pt none;"><iframe id="google_ads_iframe_/1005222/post-body-1_0" title="3rd party ad content" name="google_ads_iframe_/1005222/post-body-1_0" width="300" height="250" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" role="region" aria-label="Advertisement" tabindex="0" srcdoc="" sandbox="allow-forms allow-pointer-lock allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation allow-presentation" style="border: 0px; vertical-align: bottom;" data-google-container-id="8" data-load-complete="true"></iframe></div></zeus-ad>
</div>
</div>
</div></div></div>
<p>It’s not clear where that figure came from, but it might have originated in an article on the right-leaning website The Blaze, which <a href="http://archive.is/vQRnl" target="_blank">wrote</a>:</p>
<p>“While it is unclear how many spray cans [Cobre] has used, the mural spans four stories and at least one smaller project utilized 500 cans of the paint scientists say can generate asthma-inducing smog.”</p>
<p>The Daily Wire, another right-leaning website, subsequently <a href="http://web.archive.org/web/20191111214336/https://www.dailywire.com/news/giant-climate-killing-mural-of-greta-thunberg-now-graces-downtown-san-francisco" target="_blank">extrapolated</a> that “the Thunberg mural&nbsp;will likely take closer to 700 cans to finish.”</p>
<h4>Analysis</h4>
<p>In response to concerns about the use of aerosol spray paint, One Atmosphere, a California environmental non-profit group that collaborated with Cobre on the mural, posted the following <a href="https://www.instagram.com/p/B4sfLfcBBSM/" target="_blank">explanation</a> to Instagram on Nov. 11:</p>
<blockquote><p>Some folks have been asking about the environmental impacts of the Greta mural. Read on for some details. The vast majority of the paint is water-based acrylic exterior paint that was rolled onto the building by hand. The finishing details can only be done with spray paint, but we are using spray cans without CFCs. (CFCs are tremendously damaging to the environment). We are using low pressure cans with a minimal footprint. The cans and the boxes will also be recycled, although many of the cans will first have a second life as part of a separate art project.</p>
<p>The cans have been picked up and delivered in an electric vehicle, and the artist and organizers have been travelling almost exclusively by way of electric car, electric scooter or on foot to the project site. The lift being used is also electric, not diesel. We are doing our best to Reduce, Reuse, Recycle, in that order!</p></blockquote>
<p>After the completion of the project, One Atmosphere’s Executive Director Paul Scott provided further details to Snopes in an email. He firmly rejected the claim that the project required 700 gallons, or even 700 cans, of spray paint.</p>
<p>In reality, Scott said he counted a total of 117 used 400-ml cans of spray paint, almost all of them from the <a href="http://archive.is/B6Npy" target="_blank">MTN 94</a> brand. That’s just over 12 gallons in total. However, only some of that 400-ml capacity is taken up by the hydrocarbon propellant that escapes into the atmosphere (as opposed to the liquid paint, which ends up on the side of the building).&nbsp;</p><div id="smg-zone-post-body-2" class="smg-zone smg-zone-post-body-2"><div class="smg-zone-group smg-zone-group-single-body-2"><div class="smg-zone-widget smg-zone-widget-ads-placement  ">		<div class="PlacementWrapper smg-placement" data-ad-placement-id="post-body-2">
    <div class="Placement-placeholder is-hidden">
        <div class="Placement-loader"></div>
    </div>
    <script type="text/javascript">
...
<p>All aerosol spray paints use a propellant to help disperse the paint from the can and onto its intended surface. In the past, manufacturers used chlorofluorocarbons (CFCs), chemicals that were widely banned from the late 1980s onwards due to the fact that they deplete the <a href="http://archive.is/meKun" target="_blank">ozone layers</a> in the Arctic and Antarctic Circles.&nbsp;</p>
<p>In the United States in 2019, spray paint manufacturers use hydrocarbons such as propane and butane as propellants. Unlike CFCs, hydrocarbons don’t have a deleterious effect on ozone, but they do have a small <a href="http://web.archive.org/web/20180822143122/https://www.scientificamerican.com/article/are-aerosols-still-bad/" target="_blank">effect</a> on global warming. However, it’s worth putting the scale of that effect into some context, using a measure known as Global Warming Potential.&nbsp;</p>
<p>As the federal Environmental Protection Agency (EPA) explains on its <a href="http://archive.is/mkQcQ" target="_blank">website</a>:</p>
<p>“The Global Warming Potential (GWP) was developed to allow comparisons of the global warming impacts of different gases. Specifically, it is a measure of how much energy the emissions of 1 ton of a gas will absorb over a given period of time, relative to the emissions of 1 ton of carbon dioxide (CO<sub>2</sub>). The larger the GWP, the more that a given gas warms the Earth compared to CO<sub>2</sub> over that time period.”</p>
<p>The CFCs used as propellants in aerosol paint in the past have a GWP of between 5,000 and <a href="https://www.snopes.com/uploads/2019/11/Global-Warming-Potential-Values-Feb-16-2016_1.pdf">14,000</a>. <a href="http://archive.is/o5r7a" target="_blank">Propane</a>, a hydrocarbon commonly used now as a propellant in spray paint, has a GWP of 4. In his email to Snopes, Scott added that, “The amount of the propellant is also less because the cans are lower pressure, and obviously only a portion of each can is propellant, so the ultimate GWP impact of the cans we used is very limited.”</p>
<p>Scott told Snopes that One Atmosphere had also sought to neutralize any effects caused by the Thunberg mural through the use of carbon <a href="http://archive.is/mUPGu" target="_blank">offsets</a>. He wrote: “We purchased carbon offsets that will cover far more than the small footprint left by the limited number of spray cans used on our project.”</p>
