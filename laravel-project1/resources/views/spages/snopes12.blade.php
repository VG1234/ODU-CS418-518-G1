...
<h1 class="title" style="text-align: center">
	<b>Will the WhatsApp Message ‘Argentina Is Doing It’ Hack My Phone?</b></h1>



	<h2 class="subtitle">
		A viral warning message urged people against opening a video file about the country's response to COVID-19. 	</h2>
	...
	<div class="card mb-3">
		...
		<div class="claim-text card-body">
			...
			A WhatsApp video message known as "Argentina Is Doing It" spreads malware that irreparably hacks viewers' cell phones.
		</div>
	...
	<div class="single-body card card-body rich-text">
        ...
        <p>In July 2020, WhatsApp users reported receiving a message that claimed a video on the platform titled “Argentina is doing it” was spreading malware that would hack the cell phones of people who received the media file. The warning alert looked like this:</p>
        <p><a href="https://www.snopes.com/tachyon/2020/07/whatsapp-meme.jpg"><img loading="lazy" class="aligncenter size-full wp-image-260895" src="https://www.snopes.com/tachyon/2020/07/whatsapp-meme.jpg" alt="" width="716" height="556" data-recalc-dims="1" srcset="https://www.snopes.com/tachyon/2020/07/whatsapp-meme.jpg?resize=716%2C556&amp;zoom=1 716w, https://www.snopes.com/tachyon/2020/07/whatsapp-meme.jpg?resize=716%2C556&amp;zoom=0.5 358w, https://www.snopes.com/tachyon/2020/07/whatsapp-meme.jpg?resize=716%2C556&amp;zoom=0.25 179w" sizes="(max-width: 716px) 100vw, 716px"></a></p>
        <p>The warning alert makes several assertions: that video footage detailing Argentina’s response to the <a href="https://www.snopes.com/collections/new-coronavirus-collection/">coronavirus pandemic</a> was going to start circulating online; that that video file would irreparably compromise information on viewers cell phones in 10 seconds, and that the national news outlet, CNN, had reported on the malware scheme and/or the video about Argentina.</p>
        <p>By July 16, cautionary messages about the alleged file were spreading on Twitter, as well. Numerous Snopes readers requested that we investigate the warning alert and purported video.</p>
        <p><a href="https://www.snopes.com/tachyon/2020/07/whatsapp-tweet-2.jpg"><img loading="lazy" class="aligncenter size-full wp-image-260897" src="https://www.snopes.com/tachyon/2020/07/whatsapp-tweet-2.jpg" alt="" width="700" height="396" data-recalc-dims="1" srcset="https://www.snopes.com/tachyon/2020/07/whatsapp-tweet-2.jpg?resize=700%2C396&amp;zoom=1 700w, https://www.snopes.com/tachyon/2020/07/whatsapp-tweet-2.jpg?resize=700%2C396&amp;zoom=0.5 350w, https://www.snopes.com/tachyon/2020/07/whatsapp-tweet-2.jpg?resize=700%2C396&amp;zoom=0.25 175w" sizes="(max-width: 700px) 100vw, 700px"></a></p>
        <p>The warning — like <a href="https://www.snopes.com/fact-check/whatsapp-martinelli-phone-virus-warning/">similarly-worded</a> messages that have circulated on WhatsApp in <a href="https://www.snopes.com/fact-check/popcorn-carnival/">recent years </a>— appeared to be a hoax.</p>
        <p>First, we looked for evidence of the alleged video about the South American country’s response to the pandemic, and whether that footage had been spreading a virus that hacks people’s phones.</p>
        <p>Meanwhile, we contacted CNN to determine the legitimacy of the claim that the news outlet had reported on the scheme, or the “Argentina is doing it” video. Blair Cofield, a CNN spokesperson, said in an email to Snopes: “This is false. There is nothing on CNN platforms with that message.”</p>
        <p>In sum, it appeared that no one online actually saw or received a link to the “Argentina is doing it” video, per our analysis.</p>
        <p>Additionally, we searched for details to explain the extent to which the scheme removed or stole recipients’ cell information, and the underlying motivation behind the warning message. We found no evidence to explain the cell operating system on which the malware runs.</p>
        <p>On a <a href="https://faq.whatsapp.com/general/security-and-privacy/hoax-messages/" target="_blank">web page</a> to explain the platform’s privacy and security issues, WhatsApp says such messages that aim to deceive users often contain instructions to forward the message (“Pass the information on to your family and friends”) and claim you can avoid punishment (getting your phone hacked) if you act in a certain way. The “Argentina is doing it” message checked both those&nbsp; boxes.</p>
        <p>The WhatsApp page goes on to say people should disregard such messages, and “to avoid exposing your contacts to potential harm, please never forward these messages to them.” A cybersecurity writer for Forbes <a href="https://www.forbes.com/sites/daveywinder/2020/03/26/whatsapp-upgrade-warning-heres-what-2-billion-users-should-do/#6607c1a2e83e" target="_blank">wrote</a> in March 2020:</p>
        <p>“These hoax WhatsApp messages are the modern equivalent of the old chain letter that urged the reader to send copies on to ten people, or something terrible would happen to them. … the real problem with this kind of hoax messaging that goes viral is that it can then turn into what it purports to be: a malware distribution tool.”</p>
        <p>Given the fact that no evidence shows that the “Argentina is doing it” video exists, nor that it is part of a malware scheme to hack cell phones — as well as the similarities in language between this viral message and previous WhatsApp hoaxes — we rate this claim “False.”</p>
