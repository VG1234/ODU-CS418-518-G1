...
<h1 class="title" style="text-align: center">
	<b>Did Japan Ban 5G Technology Over Health Concerns?</b></h1>



	<h2 class="subtitle">
		More to the point, does the “Ministry of High Technologies” even exist in Japan? 	</h2>
	...
	<div class="card mb-3">
		...
		<div class="claim-text card-body">
			...
			The Japanese government banned the development of 5G technology over health concerns.
		</div>
	...
	<div class="single-body card card-body rich-text">
        ...
        <p>On June 9, 2019, a website named Putin Tomorrow posted a <a href="http://archive.fo/JBRqf" target="_blank" rel="noopener">story</a> claiming that the Japanese government would be banning 5G cellular technology “for the health of [its] citizens.” The term “5G” — 5th-generation wireless networks — is a <a href="https://www.snopes.com/fact-check/hazmat-suits-5g-equipment/" target="_blank" rel="noopener">frequent</a> <a href="https://www.snopes.com/fact-check/5g-cellular-test-birds/" target="_blank" rel="noopener noreferrer">boogeyman</a> on health conspiracy websites that allege unsubstantiated negative health effects from the technology. The Putin Tomorrow article fits that mold, claiming that the “Ministry of High Technologies” posted an announcement on their official website that they would be banning the development of, and investment in, this cellular technology, while citing someone named Nobunari Kabato as that ministry’s head:</p>


        <p>At least three reasons exist why the above assertion is baseless. First, “Nobunari Kabato” appears to be a made-up name: The only Google <a href="http://archive.fo/zDR6x#selection-653.0-653.58" target="_blank" rel="noopener noreferrer">search result</a> for it is the article we are presently debunking. Second, no “Ministry of High Technology” exists in the Japanese government. The <a href="http://www.mext.go.jp/" target="_blank" rel="noopener">closest entity</a> to that would be the “Ministry of Education, Culture, Sports, Science and Technology,” which is run by a man named Kōichi Hagiuda. Finally, and contrary to the headline claim in the article, Japan is actively investing in 5G technology.</p>

        <p>In fact, Japanese companies are actually investing in what the Nikeii Asian Review <a href="http://archive.fo/UtkRj" target="_blank" rel="noopener">described</a> as a ”14 [billion dollar] spending blitz for nationwide 5G.” In April, that outlet reported that “Japan’s government … approved plans by four mobile network operators to build superfast fifth-generation wireless networks, with investment set to total 1.6 trillion yen ($14.4 billion) over the next five years.” As such, we rate this claim as “False.”</p>
